window.REPORT = {
  ...
  { side: "bottom", date: "02/03", iso:"2026-03-02", color: "#FACC15", boxType: "light",   title: "Fechamento",   subtitle: "Portal (ex-Distr)" },
  { side: "top",    date: "03/03", iso:"2026-03-03", color: "#FB923C", boxType: "light",   title: "Bookings",     subtitle: "Prévia (MPO)" },
  { side: "bottom", date: "04/03", iso:"2026-03-04", color: "#F472B6", boxType: "light",   title: "Booking",      subtitle: "Review (Supply" },
  { side: "top",    date: "05/03", iso:"2026-03-05", color: "#A855F7", boxType: "light",   title: "Fechamento",   subtitle: "Final" },
  { side: "bottom", date: "09/03", iso:"2026-03-09", color: "#2DD4BF", boxType: "light",   title: "Bookings",     subtitle: "Finais (MPO)" },
  { side: "top",    date: "12/03", iso:"2026-03-12", color: "#F87171", boxType: "light",   title: "Alinhamento",  subtitle: "Liderança" },
  { side: "bottom", date: "18/03", iso:"2026-03-18", color: "#EAB308", boxType: "light",   title: "POs Deadline Nike", subtitle: "Upload SAP" }
],
